...
///////// 自己程序都加在main里面用extern声明成global
extern void send232(unsigned char char2send); // 往串口输出的程序
extern int fd; //rs232 port rw handle
extern unsigned char read232(); //read 232 and feedback status.
